...
def export_metrics(history, output_path="metrics.json", extra=None):
    ...
    payload = {
        "experiment_id": os.environ.get("EXPERIMENT_ID", "03_logistic_regression_increased_epochs"),
...
def main():
    print("Starting Federated Learning Central Server (5 Local Epochs)...")
    ...
    export_metrics(
        ...
        extra={
            ...
            "partitioning": "Shipping Mode (Express vs Standard)",
            "non_iid_level": "strong",
            "local_epochs": 5,
        },
    )
